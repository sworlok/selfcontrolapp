...
namespace SelfControlApplication
{
    public partial class MainForm : Form
    {
        ...
        {
            MessageBox.Show("Для выхода из программы нажмите \"Файл\" -> \"Выход\" (Ctrl + Q)\n", "Справка");
        }
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Во избежание проблем с доступностью блокируемых сайтов, НЕ ВЫХОДИТЕ из программы до окончания работы таймера.", "ВНИМАНИЕ!");
